...
Effet.o:
	g++ -g -Wall include/Effet/Effet.cpp -o obj/Debug/include/Effet/Effet.o -c
...
PillerPiece.o: EtatJoueur.o Joueur.o
	g++ -g -Wall include/Personnage/Joueur/EtatJoueur/PillerPiece/PillerPiece.cpp -o obj/Debug/include/Personnage/Joueur/EtatJoueur/PillerPiece/PillerPiece.o -c
...
ComportementEffet.o:
	g++ -g -Wall include/Effet/ComportementEffet/ComportementEffet.cpp -o obj/Debug/include/Effet/ComportementEffet/ComportementEffet.o -c
	
MalusBonus.o:ComportementEffet.o
	g++ -g -Wall include/Effet/ComportementEffet/MalusBonus/MalusBonus.cpp -o obj/Debug/include/Effet/ComportementEffet/MalusBonus/MalusBonus.o -c



MalusBonusDeguerpir.o:ComportementEffet.o
	g++ -g -Wall include/Effet/ComportementEffet/MalusBonusDeguerpir/MalusBonusDeguerpir.cpp -o obj/Debug/include/Effet/ComportementEffet/MalusBonusDeguerpir/MalusBonusDeguerpir.o -c
	
PerteGainNiv.o:ComportementEffet.o
	g++ -g -Wall include/Effet/ComportementEffet/PerteGainNiv/PerteGainNiv.cpp -o obj/Debug/include/Effet/ComportementEffet/PerteGainNiv/PerteGainNiv.o -c


CarteSupMain.o:ComportementEffet.o
	g++ -g -Wall include/Effet/ComportementEffet/CarteSupMain/CarteSupMain.cpp -o obj/Debug/include/Effet/ComportementEffet/CarteSupMain/CarteSupMain.o -c
...
FabriqueCarte.o: Munchkin.o
	g++ -g -Wall include/Fabrique/FabriqueCarte.cpp -o obj/Debug/include/Fabrique/FabriqueCarte.o -c
	
FabriqueTresor.o: FabriqueCarte.o
	g++ -g -std=c++0x -Wall include/Fabrique/FabriqueTresor.cpp -o obj/Debug/include/Fabrique/FabriqueTresor.o -c
	
FabriquePorte.o: FabriqueCarte.o
	g++ -g -std=c++0x -Wall include/Fabrique/FabriquePorte.cpp -o obj/Debug/include/Fabrique/FabriquePorte.o -c
	
FabriqueEffet.o: FabriqueCarte.o
	g++ -g -std=c++0x -Wall include/Fabrique/FabriqueEffet.cpp -o obj/Debug/include/Fabrique/FabriqueEffet.o -c
